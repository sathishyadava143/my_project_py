...
export default class Registration extends Component {
  ...
  validateCode = () => {
   const predefined = "978707"; // Change this to your desired code
    if (this.state.codeInput === predefined) {
      alert("Code is valid!");
    } else {
      <button disabled onClick={this.registerAsVoter }>{this.state.currentVoter.isRegistered
        ? "Update"
        : "Register"}</button>
    }
  };
            ...
            <div className="container-main">
              ...
              <div className="container-item">
                <form>
                  ...
                  <div className="div-li">
                    <label className={"label-r"}>
                      Pass_Code<span style={{ color: "tomato" }}>*</span>
                      <input
                        className={"input-r"}
                        type="number"
                        placeholder="eg. 012345"
                        value={this.state.codeInput}
                        onChange={this.updateCodeInput}
                      />
                    </label>
                  </div>
                  <p className="note">
                    <span style={{ color: "tomato" }}> Note: </span>
                   <li><span> Your Aadhaar_Number is Already Verified to register your name to vote.</span></li> 
                    <li>Make sure your account address and Phone number are correct.</li>
                  </p>
                  <button
                    className="btn-add"
                    disabled={
                      this.state.codeInput !== "978707"||
